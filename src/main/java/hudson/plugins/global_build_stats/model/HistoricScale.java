...
public enum HistoricScale {
    ...
    WEEKLY(
            ...
            new Integer[] {Calendar.DAY_OF_WEEK, Calendar.HOUR_OF_DAY, Calendar.MINUTE},
            "%W%w, EEE") {
        @Override
        public String getUnitLabel() {
    ...
    MONTHLY(
            Calendar.MONTH,
            new Integer[] {Calendar.DAY_OF_MONTH, Calendar.HOUR_OF_DAY, Calendar.MINUTE},
            "dd MMM ''yy") {
        @Override
        public String getUnitLabel() {
    ...
    YEARLY(
            Calendar.YEAR,
            new Integer[] {Calendar.MONTH, Calendar.DAY_OF_YEAR, Calendar.HOUR_OF_DAY, Calendar.MINUTE},
            "''yy %d%D") {
        @Override
        public String getUnitLabel() {
    ...
    public DateFormat getDateRangeFormatter() {
        ...
        for (Entry<String, String> entry :
                getDateRangeFormatterLocalizedConversionMap().entrySet()) {
