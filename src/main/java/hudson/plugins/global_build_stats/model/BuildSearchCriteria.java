...
public class BuildSearchCriteria {
    ...
    public BuildSearchCriteria(
            String _jobFilter,
            String _nodeFilter,
            boolean _successShown,
            boolean _failuresShown,
            boolean _unstablesShown,
            boolean _abortedShown,
            boolean _notBuildsShown) {
    ...
    protected FieldFilter getCalculatedJobFilter() {
        ...
        // will be null !
        if (calculatedJobFilter == null) {
            calculatedJobFilter = FieldFilterFactory.createFieldFilter(jobFilter);
        }
    ...
    protected FieldFilter getCalculatedNodeFilter() {
        ...
        // will be null !
        if (calculatedNodeFilter == null) {
            calculatedNodeFilter = FieldFilterFactory.createFieldFilter(nodeFilter);
        }
    ...
    protected FieldFilter getCalculatedLauncherFilter() {
        ...
        // will be null !
        if (calculatedLauncherFilter == null) {
            calculatedLauncherFilter = FieldFilterFactory.createFieldFilter(launcherFilter);
        }
