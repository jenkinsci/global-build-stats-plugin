...
public class BuildStatConfiguration implements Serializable {
     ...
     */
    @Deprecated
    private transient String jobFilter = FieldFilterFactory.ALL_VALUES_FILTER_LABEL;
     ...
     */
    @Deprecated
    private transient String nodeFilter = FieldFilterFactory.ALL_VALUES_FILTER_LABEL;
    ...
    public BuildStatConfiguration(
            String _id,
            String _buildStatTitle,
            int _buildStatWidth,
            int _buildStatHeight,
            int _historicLength,
            HistoricScale _historicScale,
            YAxisChartType _yAxisChartType,
            boolean _buildCountsShown,
            boolean _totalBuildTimeShown,
            boolean _averageBuildTimeShown,
