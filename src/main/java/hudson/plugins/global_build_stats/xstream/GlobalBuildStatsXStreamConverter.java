...
public class GlobalBuildStatsXStreamConverter implements Converter {
    ...
    public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
        ...
        if (versionNumber != getCurrentGlobalBuildStatsVersionNumber()) {
            ...
            LOGGER.info("Your version of persisted GlobalBuildStatsPlugin data is not up-to-date (v" + versionNumber
                    + " < v" + getCurrentGlobalBuildStatsVersionNumber() + ") : data will be migrated !");
        }
