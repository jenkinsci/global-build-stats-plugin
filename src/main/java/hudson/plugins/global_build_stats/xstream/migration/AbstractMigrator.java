...
public abstract class AbstractMigrator<TFROM extends GlobalBuildStatsPOJO, TTO extends GlobalBuildStatsPOJO>
    ...
    public TTO readGlobalBuildStatsPOJO(HierarchicalStreamReader reader, UnmarshallingContext context) {
        ...
        while (reader.hasMoreChildren()) {
            ...
            BuildStatConfiguration bsc =
                    (BuildStatConfiguration) context.convertAnother(pojo, BuildStatConfiguration.class);
        ...
        reader.moveDown();
        List<RetentionStrategy> retentionStrategiesFakedInstances =
                (List<RetentionStrategy>) context.convertAnother(pojo, List.class);
        List<RetentionStrategy> retentionStrategies =
                new ArrayList<RetentionStrategy>(retentionStrategiesFakedInstances.size());
